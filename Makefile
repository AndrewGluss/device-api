...
goallure:
	...
	go test -v -tags allure_test ./test/http_test/...
	go test -v -tags allure_test ./test/grpc_test/...

.PRONY: serve
serve:
	allure serve ./test/grpc_test/allure-results
	allure serve ./test/http_test/allure-results
...
.PHONY: dc-env-down
dc-env-down:
	docker-compose -p ozon_route256 -f docker-compose.service-env.yaml down
